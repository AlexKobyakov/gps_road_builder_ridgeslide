...
translations = {
    ...
    'col_message': 'Message',
    'status_ok': 'OK',
    'metric_input': 'Input points',
    'metric_duplicates_removed': 'Duplicates removed',
    'metric_near_dup_removed': 'Near duplicates removed',
    'metric_reb_removed': 'REB/spoofing removed',
    'metric_tracks': 'Tracks',
    'metric_tiles': 'Tiles',
    'metric_edges': 'Edges',
    'metric_nodes': 'Nodes',
    'duration_hours': '{0} h',
    ...
    'deps_purpose_pandas': 'Core tabular data and CSV/XLSX support',
    ...
    'default_layer_name': 'GPS Road Network',
    ...
    'multilingual_support': 'Multilingual interface (12 languages).',
...
# --- QGIS Processing provider (stable machine IDs are in processing_provider/ids.py) ---
translations.update({
    'processing_provider_name': 'GPS Road Builder',
    'processing_group': 'GPS Road Builder',
    'processing_help_general': 'Build or post-process a GPS road network without opening the plugin dialog.',
    'processing_build_from_layer': 'Build road network from layer',
    'processing_build_from_folder': 'Build road network from folder',
    'processing_postprocess_network': 'Post-process road network',
    'processing_input_layer': 'Input point or line layer',
    'processing_input_folder': 'Input CSV/XLSX folder',
    'processing_input_network': 'Input line network',
    'processing_output_network': 'Output road network',
    'processing_preset': 'Preset',
    'processing_method': 'Method',
    'processing_cell_size': 'Cell size, m',
    'processing_min_frequency': 'Minimum edge frequency',
    'processing_min_length': 'Minimum edge length, m',
    'processing_max_speed': 'Maximum speed, km/h',
    'processing_max_acceleration': 'Maximum acceleration, m/s²',
    'processing_min_point_distance': 'Minimum point distance, m',
    'processing_gap_time': 'Time gap, min',
    'processing_gap_distance': 'Distance gap, m',
    'processing_resample_step': 'Resampling step, m',
    'processing_sigma1': 'Density smoothing σ1, px',
    'processing_sigma2': 'Density smoothing σ2, px',
    'processing_sharpness': 'Kernel sharpness',
    'processing_threshold_mode': 'Threshold mode',
    'processing_threshold_percentile': 'Density percentile, %',
    'processing_simplify_tolerance': 'Simplification tolerance, m',
    'processing_spur_length': 'Remove dangling spurs shorter than, m',
    'processing_smooth_iterations': 'Smoothing iterations',
    'processing_connect_gap': 'Connect gaps within radius, m',
    'processing_bridge_facing': 'Bridge facing dead ends up to, m',
    'processing_stitch_max': 'Stitch components up to, m',
    'processing_break_crossings': 'Break edges at crossings',
    'processing_junction_distance': 'Merge junction clusters within, m',
    'processing_min_component': 'Remove components shorter than, m',
    'processing_keep_largest': 'Keep only the largest network',
    'processing_stage': 'Stage: {0}',
    'processing_building': 'Building road network',
    'processing_postprocessing': 'Post-processing road network',
    'processing_written': 'Written features: {0}',
    'processing_cancelled': 'Processing was cancelled.',
    'processing_partial_result': 'Partial checkpoint result cannot be written as a network.',
    'processing_sink_failed': 'Could not create the output feature sink.',
    'processing_invalid_input': 'Invalid or unavailable input layer.',
    'processing_invalid_folder': 'Choose an input folder.',
    'processing_empty_input': 'The input contains no usable point or line features.',
    'processing_build_failed': 'Road network build failed',
    'processing_postprocess_failed': 'Road network post-processing failed',
})
